function CSS() {
  ...
  <div className="sm:borderl  w-300  border rounded bg-blue-100 p-4">
    <div className="flex flex-col sm:flex-row sm:items-start sm:gap-4">
      ...
      <img src="/src/components/Courses/Channels/CSS/hitesh choudhary.jpg" className='w-full h-full object-cover'></img>
      </div>
  ...
  <div className="sm:borderl  w-300  border rounded bg-blue-100 p-4">
    <div className="flex flex-col sm:flex-row sm:items-start sm:gap-4">
      ...
      <div className="h-[130px] w-[150px] sm:h-40 sm:w-40 border rounded-md mx-auto sm:mx-0 mb-4 sm:mb-0">
      <img src="/src/components/Courses/Channels/CSS/sheryians.jpeg" className='w-full h-full object-cover'></img>
      </div>
