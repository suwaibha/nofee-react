        ...
        <div className="sm:borderl  w-300  border rounded bg-blue-100 p-4">
          <div className="flex flex-col sm:flex-row sm:items-start sm:gap-4">
            <div className="h-[130px] w-[150px] sm:h-40 sm:w-40 border rounded-md mx-auto sm:mx-0 mb-4 sm:mb-0">
              <img
                src="/src/components/Courses/Channels/Python/shraddha.jpeg"
      ...
      <div className="flex justify-center sm:mt-10 mb-10 mx-5">
        <div className="sm:borderl  w-300  border rounded bg-blue-100 p-4">
          <div className="flex flex-col sm:flex-row sm:items-start sm:gap-4">
            <div className="h-[130px] w-[150px] sm:h-40 sm:w-40 border rounded-md mx-auto sm:mx-0 mb-4 sm:mb-0">
              <img
                src="/src/components/Courses/Channels/Python/hitesh choudhary.jpg"
                className="w-full h-full object-cover"
              ></img>
            </div>
            ...
            <div className="flex flex-col sm:w-full">
              ...
              <p className="text-sm text-gray-700 text-center sm:text-left mt-1">
                ...
                over chai and I am a big-time chai lover. Let's sip tea and
                write some code and some chit-chat. Ab ye b Hindi me linkne to
                mat bolna, abhi ke liye itna hi likenge. Baaki baad me.
              </p>
      ...
      <div className="flex justify-center sm:mt-10 mb-10 mx-5">
        <div className="sm:borderl  w-300  border rounded bg-blue-100 p-4">
          <div className="flex flex-col sm:flex-row sm:items-start sm:gap-4">
            <div className="h-[130px] w-[150px] sm:h-40 sm:w-40 border rounded-md mx-auto sm:mx-0 mb-4 sm:mb-0">
              <img
                src="/src/components/Courses/Channels/Python/mosh.jpg"
                className="w-full h-full object-cover"
              ></img>
            </div>
            ...
            <div className="flex flex-col sm:w-full">
              ...
              <p className="text-sm text-gray-700 text-center sm:text-left mt-1">
                Mosh is a seasoned software engineer sharing practical coding
                tutorials and real-world projects to help learners build skills
                and land tech jobs.
              </p>
