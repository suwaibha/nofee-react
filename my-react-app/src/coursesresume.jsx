             ...
             <main className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 p-6 ">
               {courses.map((course, index) => (
                 ...
                 >
                   ...
                   <button onClick={()=>alert("Your Video Has Been Resumed") }
                   className="font-medium text-white bg-blue-500 hover:bg-blue-900 border-1 rounded-2xl p-2 border-black py-1  ">
                        Resume
                   </button>
                 </div>
               ))}
